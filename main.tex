...
\input{01innledning}
\newpage
\input{02datastrukturer}
\newpage
\input{03kjoretidsberegning}
\newpage
\input{04rekursjon}
\newpage
\input{05sorteringogsoking}
\newpage
\input{06graferoggrafalgoritmer}
\newpage
\input{07dynamiskprogrammering}
\newpage
\input{08gradigealgoritmer}
\newpage
\input{09minimalespenntraer}
\newpage
\input{10problemkompleksitet}
\newpage
\input{11kjoretidertilpensumalgoritmer}
\newpage
\input{12linearprog}
